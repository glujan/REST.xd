...
YTDL_OPTS       = {'quiet': True, 'prefer_insecure': True, 'no_warnings': True}
YOUTUBE_OEMBED  = "https://www.youtube.com/oembed?url={url}"
YOUTUBE_SEARCH  = "https://content.googleapis.com/youtube/v3/search"
...
URBAN_DICT      = "http://api.urbandictionary.com/v0/define"
